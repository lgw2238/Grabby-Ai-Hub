package com.lgw.grabby.repository

import com.lgw.grabby.exception.DocumentProcessingException
import com.lgw.grabby.service.DocumentProcessingService
import com.lgw.grabby.domain.dto.DocumentSearchResultDto
import com.lgw.grabby.service.EmbeddingService
...
class InMemoryDocumentVectorStore(
    ...
    fun addDocument(id: String, fileText: String, metadata: Map<String, Any>) {
        ...
        try {
            ...
            /**
             * Spring AI 1.0.0 버전 엣지 케이스로 위의 builder 요소중 하나라도 set 하지 않으면 Error 발생
             * 이후 Fetch 버전이 나오면 해당 로직 변경.
             */
